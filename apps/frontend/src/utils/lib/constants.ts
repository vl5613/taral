...
export const ESCROW_STORAGE_CONTRACT = devnet
  ? "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.escrow-storage"
  : process.env.NEXT_PUBLIC_ESCROW_STORAGE_CONTRACT || "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.escrow-storage";

export const TARAL_ESCROW_CONTRACT = devnet
  ? "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.taral-escrow"
  : process.env.NEXT_PUBLIC_TARAL_ESCROW_CONTRACT || "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.taral-escrow";
